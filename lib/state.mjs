...
/**
 * How long Jev stays at the machine after buying something.
 *
 * The question of getting up is asked on every spin, so at anything like a
 * normal stop probability Jev left the machine about once a minute and the page
 * was a shopping feed with a slot machine in the corner. During the cooldown the
 * question is not asked at all, rather than asked and then overruled.
 */
export const SHOP_COOLDOWN_MS = 15 * 60 * 1000;
